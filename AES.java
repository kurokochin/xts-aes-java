/*
 * Class AES
 * Diambil dari class AES pada AESCalc.jar
 * Dimodifikasi sesuai kebutuhan
 * 
 * Copyright Grace Angelica, Ricky Putra Nursalim, Stephen Jaya Gunawan
 */
import java.util.*;
...
class AES {
    ...
    public void setKey(byte[] key) {
        ...
        if (traceLevel > 3) {
            ...
            for (r = 0; r < numRounds + 1; r++)
                traceInfo += "  R" + r + "\t = " + Util.toHEX1(Ke[r]) + "\n";
            traceInfo += "  Decrypt Round keys:\n";
            for (r = 0; r < numRounds + 1; r++)
                traceInfo += "  R" + r + "\t = " + Util.toHEX1(Kd[r]) + "\n";
        }
    }
    ...
    public static void main(String[] args) {
        ...
        self_test("000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f",
                "00112233445566778899aabbccddeeff", "8ea2b7ca516745bfeafc49904b496089", lev);
    }
}
